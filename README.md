...
- 🤖 Building practical applications with **AI integrations**
- ⚡ Built real-time features using **Socket.IO and SSE**
...
### 🎨 Frontend
<p><img src="https://skillicons.dev/icons?i=react,nextjs,reactnative,expo,javascript,typescript,html,css,tailwind,vite&theme=dark"/></p>

### ⚙️ Backend
<p><img src="https://skillicons.dev/icons?i=nodejs,express,python,fastapi&theme=dark"/></p>

### 🗄️ Database
<p><img src="https://skillicons.dev/icons?i=mongodb,mysql,postgresql&theme=dark"/></p>

### 🤖 AI & Real-Time
<p><img src="https://skillicons.dev/icons?i=socketio&theme=dark"/></p>
<p><code>Google Gemini API</code> • <code>Socket.IO</code> • <code>Server-Sent Events</code> • <code>REST APIs</code></p>

### 🔐 Authentication & Security
<p><code>JWT</code> • <code>HTTP-only Cookies</code> • <code>Role-Based Access Control</code> • <code>Zod Validation</code></p>

### ☁️ Cloud & Deployment
<p><code>Vercel</code> • <code>Render</code> • <code>Cloudinary</code> • <code>EAS Build</code> • <code>ImageKit</code></p>

### 🧰 Tools & Platforms
<p><img src="https://skillicons.dev/icons?i=git,github,docker,vscode,postman,linux&theme=dark"/></p>
...
<div align="center">
<a href="https://github.com/FarrukhGul"><img width="49%" src="https://raw.githubusercontent.com/FarrukhGul/FarrukhGul/main/profile/stats.svg" alt="Farrukh GitHub Stats"/></a>
<a href="https://github.com/FarrukhGul"><img width="49%" src="https://raw.githubusercontent.com/FarrukhGul/FarrukhGul/main/profile/streak.svg" alt="Farrukh Streak Stats"/></a>
<br/><br/>
<a href="https://github.com/FarrukhGul"><img width="40%" src="https://raw.githubusercontent.com/FarrukhGul/FarrukhGul/main/profile/top-langs.svg" alt="Farrukh Top Languages"/></a>
</div>
...
### 🌐 Gateway Canada — Client Project
**July 2026 · Freelance Full-Stack Developer**
- Built and deployed a production visa-services portal for an immigration consultancy
- Developed multi-step applications, validation, document storage and application tracking
- Implemented JWT admin authentication with HTTP-only cookies
- Added secure signed URLs, downloadable e-ticket PDFs and Postman API testing
- Deployed frontend on Vercel and backend on Render

### 🏢 Teyzix Core — Remote
**May 2026 – June 2026 · Full-Stack Developer Intern**
- Worked under senior developers in an early-stage software house
- Contributed to three projects from requirements through deployment
- Built an internship portal with React, Node.js, Express, MongoDB, JWT and Zod
- Implemented protected routes and role-based access
- Contributed to a real-time collaborative document editor using Socket.IO and Yjs
